...
class EventListViewTest(TestCase):
    ...
    def test_event_list_view_with_events(self):
        event = Event.objects.create(title='Test Event', location='Test Location', startDateTime='2024-05-20T13:00:00Z', endDateTime='2024-05-20T19:00:00Z')
        response = self.client.get(self.url)
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'Test Event')

    def test_event_list_view_with_search_query(self):
        event = Event.objects.create(title='Test Event 2', location='Test Location', startDateTime='2024-05-20T13:00:00Z', endDateTime='2024-05-20T19:00:00Z')
...
class EventDetailViewTest(TestCase):
    def setUp(self):
        self.event = Event.objects.create(title='Test Event 3', location='Test Location', startDateTime='2024-05-20T13:00:00Z', endDateTime='2024-05-20T19:00:00Z')
...
class RegisterForEventViewTest(TestCase):
    def setUp(self):
        self.event = Event.objects.create(title='Test Event', location='Test Location', startDateTime='2024-05-20T13:00:00Z', endDateTime='2024-05-20T19:00:00Z')
